...
|-----------|-------------|-------------|----------|
| fibonacci(25) | 1648ms | 1067ms (1.54x) | 1244ms (1.32x) |
| for loop sum (10K) | 53ms | 54ms (0.97x) | — |
| quicksort (200 x10) | 487ms | 447ms (1.09x) | 499ms (0.98x) |
| ackermann(3,4) | 89ms | 57ms (1.56x) | — |
| hot add (10K calls) | 102ms | 87ms (1.17x) | 81ms (1.26x) |
