...
- [x] 13-2: do-while
- [x] 13-3: for-in
- [x] 13-4: bitwise operators (`&`, `|`, `^`, `~`) + shift (`<<`, `>>`, `>>>`)
- [x] 13-5: 0x/0b/0o 数値リテラル + `**` 演算子
- [x] 13-6: optional chaining `?.` + nullish coalescing `??`
- [x] 13-7: test262 準拠率確認 → 13-7-test-result.md

## 結果

- test262: TW 2,649/10,697 (29.6%), VM 2,650/10,697 (29.6%)
- TW/VM 差: 51 件 (TW only) / 16 件 (VM only)
- 共通 fail の主因: パーサー未対応 (3,745件), ビルトイン未定義 (380件)
